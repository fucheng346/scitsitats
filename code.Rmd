...
[talk abt use of transformation x ^ lambda where lambda = 0.025]{style="color:blue"}
...
[insert distribution analysis stuff like skewed / normal?]{style="color:blue"}
...
[something about balance across levels ie gender]{style="color:blue"}
...
mod.base <- lm(charges.t ~ age + sex + bmi + children + smoker + region, df_train)
summary(mod.base)
