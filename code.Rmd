...
[The multiple R-squared statistic (0.7421) indicates that 74.21% of the variation in the dependent variable (charges.t) is explained by the independent variables (smoker and age.t). This suggests that other factors not included in the model might also influence medical insurance charges.]
...
```{r Forward Stepwise Model, echo=TRUE}
step(mod.base, scope = ~ age.t + smoker + sex + bmi + children + region + bmi*region, direction = "forward", trace = 1)
